...
//}
 ...
 function spawnEnemyShips(){
   if(frameCount % 60 === 0){
     var enemy = createSprite(700,300,10,40)
     enemy.velocity.x = -10;
     ...
     switch(rand) {
        case 1: enemy.addImage(en_img)
                break;
        case 2: enemy.addImage(enemy_img)
                break;
        case 3: enemy.addImage(enemy_img)
                break;
        case 4: enemy.addImage(enemy_img)
                break;
